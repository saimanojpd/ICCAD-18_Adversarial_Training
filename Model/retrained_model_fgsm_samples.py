...
x_sample = x_test[7009].reshape(28, 28)
adv_x_sample = adv_x[7009].reshape(28, 28)
...
test_image = adv_x[1]
classes = model.predict_classes(adv_x[1:2], batch_size=10)
print (classes)

################################### Saving adversarial inputs (TEST DATA)###################################
import pickle
filename = '/home/labadmin/Desktop/iccad_2018/fgsm_retrain/results_file/fgsm_train_3'
