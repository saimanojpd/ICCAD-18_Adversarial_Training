...
carl = CarliniWagnerL2(wrap, sess=sess)
carl_params ={'binary_search_steps':15,
                 'max_iterations':500,
                 'learning_rate': 1e-2,
                 'batch_size': 1,
                 'confidence':0,
                 'abort_early':True,
                'initial_const': 1e-3}
adv_x = carl.generate_np(x_test, **carl_params)
...
import pickle
filename = '/home/labadmin/Desktop/iccad_2018/fgsm_retrain/results_file/fgsm_train_cw_3'
